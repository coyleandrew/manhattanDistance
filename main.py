...
'''
def manhattanDistance(first_point, second_point):
    ...
    manhattanDistance = x_distance + y_distance
...
if __name__ == "__main__":
    ...
    while True:
        ...
        while not validInput(first_x_coord):
        ...
        while not validInput(first_y_coord):
            print("ERROR: Input must be an integer")
            first_y_coord = input("Please enter y-coordinate of first point: ")
        ...
        while not validInput(second_x_coord):
            print("ERROR: Input must be an integer")
            second_x_coord = input("Please enter x-coordinate of second point: ")
        ...
        while not validInput(second_y_coord):
            print("ERROR: Input must be an integer")
            second_y_coord = input("Please enter y-coordinate of second point: ")
